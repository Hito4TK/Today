...
//  Today
//
//  Created by Hito4TK on 2022/04/25.
//
...
extension ReminderListViewController {
    ...
    func updateSnapshot(reloading idsThatChenged: [Reminder.ID] = []) {
        let ids = idsThatChenged.filter { id in
            filterReminders.contains { $0.id == id }
        }
